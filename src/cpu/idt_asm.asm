...
global isr32, isr33, isr48, isr128
...
ISR_NO_ERROR_CODE 32    ; Timer     (IRQ 0, legacy PIT)
ISR_NO_ERROR_CODE 33    ; Keyboard  (IRQ 1)
ISR_NO_ERROR_CODE 48    ; LAPIC timer (per-core scheduling tick)
ISR_NO_ERROR_CODE 128   ; Syscall   (int 0x80, software)
